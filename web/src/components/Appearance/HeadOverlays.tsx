...
export type HeadOverlaysCategory = 'hair' | 'skin' | 'makeup';

interface HeadOverlaysProps {
  category: HeadOverlaysCategory;
  settings: {
    hair: HairSettings;
...
const HeadOverlays = ({
  ...
  const fadeValue = useCallback(() => {
    ...
    return indexFade !== undefined && indexFade >= 0 ? indexFade : 0;
  }, [data.fade?.name])();
  ...
  return (
    <>
      {category === 'hair' && (
        <Section title={locales.headOverlays.hair.title} deps={[settings]}>
          <Input
      ...
      {category === 'hair' && isPedFreemodeModel && (
        <>
          <Section title={locales.headOverlays.eyebrows}>
            <RangeInput
          ...
          <Section title={locales.headOverlays.beard}>
            <RangeInput
              title={locales.headOverlays.opacity}
          ...
          <Section title={locales.headOverlays.chestHair}>
            <RangeInput
              title={locales.headOverlays.opacity}
      ...
      {category === 'makeup' && isPedFreemodeModel && (
        <>
          <Section title={locales.headOverlays.makeUp}>
            <RangeInput
              title={locales.headOverlays.opacity}
          ...
          <Section title={locales.headOverlays.blush}>
            <RangeInput
              title={locales.headOverlays.opacity}
          ...
          <Section title={locales.headOverlays.lipstick}>
            <RangeInput
              title={locales.headOverlays.opacity}
      ...
      {category === 'skin' && isPedFreemodeModel && (
        <>
          <Section title={locales.headOverlays.eyeColor}>
            <Input
              title={locales.headOverlays.style}
          ...
          <Section title={locales.headOverlays.blemishes}>
            <RangeInput
              title={locales.headOverlays.opacity}
          ...
          <Section title={locales.headOverlays.ageing}>
            <RangeInput
              title={locales.headOverlays.opacity}
          ...
          <Section title={locales.headOverlays.complexion}>
            <RangeInput
              title={locales.headOverlays.opacity}
          ...
          <Section title={locales.headOverlays.sunDamage}>
            <RangeInput
              title={locales.headOverlays.opacity}
          ...
          <Section title={locales.headOverlays.moleAndFreckles}>
            <RangeInput
              title={locales.headOverlays.opacity}
          ...
          <Section title={locales.headOverlays.bodyBlemishes}>
            <RangeInput
              title={locales.headOverlays.opacity}
