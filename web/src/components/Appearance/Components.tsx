...
// Which component sections belong to the "clothing" tab; everything else falls
// into "accessories" alongside the prop entries. Keeps the split in one place
// so it's easy to retune.
const CLOTHING_KEYS = new Set([
  'jackets',     // component 11
  'shirts',      // component 8  (undershirt)
  'upperBody',   // component 3  (arms & gloves)
  'lowerBody',   // component 4  (pants)
  'shoes',       // component 6
  'decals',      // component 10
]);
...
const showSection = (mode: 'clothing' | 'accessories', key: string) =>
  mode === 'clothing' ? CLOTHING_KEYS.has(key) : !CLOTHING_KEYS.has(key);
...
const Components = ({
  ...
  const show = (key: string) => showSection(mode, key);
  ...
  return (
    <>
      {show('head') && !isPedFreemodeModel && <Section title={locales.components.head}>
        <FlexWrapper>
          <Input
      ...
      {show('masks') && componentConfig.masks && <Section title={locales.components.mask}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('scarfAndChains') && componentConfig.scarfAndChains && !hasTracker && <Section title={locales.components.scarfAndChains}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('jackets') && componentConfig.jackets && <Section title={locales.components.jackets}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('shirts') && componentConfig.shirts && <Section title={locales.components.shirt}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('bodyArmor') && componentConfig.bodyArmor && <Section title={locales.components.bodyArmor}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('bags') && componentConfig.bags && <Section title={locales.components.bags}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('upperBody') && componentConfig.upperBody && <Section title={locales.components.upperBody}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('lowerBody') && componentConfig.lowerBody && <Section title={locales.components.lowerBody}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('shoes') && componentConfig.shoes && <Section title={locales.components.shoes}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
      ...
      {show('decals') && componentConfig.decals && <Section title={locales.components.decals}>
        <FlexWrapper>
          <Input
            title={locales.components.drawable}
