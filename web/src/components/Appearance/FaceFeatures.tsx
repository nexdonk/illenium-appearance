...
const FaceFeatures = ({ settings, storedData, data, handleFaceFeatureChange }: FaceFeaturesProps) => {
  ...
  return (
    <>
      <Section title={locales.faceFeatures.nose.title}>
        <RangeInput
      ...
      <Section title={locales.faceFeatures.eyebrows.title}>
        <RangeInput
      ...
      <Section title={locales.faceFeatures.cheeks.title}>
        <RangeInput
      ...
      <Section title={locales.faceFeatures.eyesAndMouth.title}>
        <RangeInput
      ...
      <Section title={locales.faceFeatures.jaw.title}>
        <RangeInput
      ...
      <Section title={locales.faceFeatures.chin.title}>
        <RangeInput
      ...
      <Section title={locales.faceFeatures.neck.title}>
        <RangeInput
