...
const Props = ({ settings, data, storedData, handlePropDrawableChange, handlePropTextureChange, propConfig }: PropsProps) => {
  ...
  return (
    <>
      {propConfig.hats && <Section title={locales.props.hats}>
        <FlexWrapper>
          <Input
      ...
      {propConfig.glasses && <Section title={locales.props.glasses}>
        <FlexWrapper>
          <Input
            title={locales.props.drawable}
      ...
      {propConfig.ear && <Section title={locales.props.ear}>
        <FlexWrapper>
          <Input
            title={locales.props.drawable}
      ...
      {propConfig.watches && <Section title={locales.props.watches}>
        <FlexWrapper>
          <Input
            title={locales.props.drawable}
      ...
      {propConfig.bracelets && <Section title={locales.props.bracelets}>
        <FlexWrapper>
          <Input
            title={locales.props.drawable}
